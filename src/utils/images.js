...
import saldo from "../assets/icons/saldo.svg";
import card from "../assets/icons/card.svg";
import check from "../assets/icons/check.svg";
import empty_check from "../assets/icons/empty_check.svg";
import gears from "../assets/icons/gears.svg";
import dashboard_fill from "../assets/icons/dashboard-fill.svg";
import mutasi from "../assets/icons/mutasi.svg";
...
import anyar_circle from "../assets/icons/anyar-circle.svg";
import anyargroup from"../assets/icons/anyargroup.svg";
...
export const iconsImgs = {
    alert, bell, bills, saldo, card, check, empty_check, gears, dashboard_fill, anyar_circle, anyargroup, mutasi, menu, plane, plus, report, search, user, wallet, wealth
}
